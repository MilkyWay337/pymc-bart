...
class TargetSplitRule(SplitRule):
    ...
    For use with MHDecisionTableSampler - requires external computation of target statistics.
    """

    @staticmethod
    def get_split_value(available_splitting_values):
        """
        For TargetSplit, the values should be pre-transformed to target statistics.
        Use continuous split logic on the transformed values.
        """
        return ContinuousSplitRule.get_split_value(available_splitting_values)
    ...
    def divide(available_splitting_values, split_value):
        ...
        Use continuous split logic on the transformed values.
        """
        return ContinuousSplitRule.divide(available_splitting_values, split_value)
